             ...
             <header id={"home"}>
                 <nav id={"nav-wrap"}>
                     ...
                     <ul id={"nav"} className={"nav"}>
                         ...
                         <li onClick={handleCurrent}><a href={process.env.PUBLIC_URL + "/public/Downloads/tusheet_resume.pdf"} download={"tusheet_resume.pdf"}>Download Resume <i className={"fas fa-download"}/></a></li>
                     </ul>
                 </nav>
